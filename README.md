...
**Demo Link**: [Upload your demo to Google Drive and add link here]

The demo should show:
1. Installing and setting up queuectl
2. Enqueuing jobs
3. Starting multiple workers
4. Viewing job status and lists
5. Handling failed jobs and DLQ
...
- Check for port/file conflicts

### Jobs Stuck in Processing

- Workers may have crashed
- Run: `queuectl worker stop` then restart
- Storage layer includes stale lock cleanup (300s timeout)
